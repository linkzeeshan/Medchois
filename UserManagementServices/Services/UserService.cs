...
namespace UserManagementServices.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<ApiResponse<string>> ResetPasswordAsync(ResetPasswordViewModel resetPassword)
        {
            var user = await _userManager.FindByEmailAsync(resetPassword.Email);
            if (user != null)
            {
                var resetPassowrd = await _userManager.ResetPasswordAsync(user, resetPassword.Token, resetPassword.Password);
